...
)
{
    ...
    EventSelect::doMinBiasCut = false; // PPG04::isMC;
    ...
    PPG04Output::outfile = "jets_output.root"; // default output file name
    ...
    // embedding
    PPG04::doEmbedding = true;
    Embdedding::doTruth = false;
    Embdedding::doSimRetower = false;
    Embdedding::doSim = false;

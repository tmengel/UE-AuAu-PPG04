...
void Process_Calo_Fitting()
{
  ...
  //60 ADC SZS
  ctbEMCal->set_softwarezerosuppression(true, CaloFittingOps::cemc_software_zs);
  ...
  //30 ADC SZS
  ctbIHCal->set_softwarezerosuppression(true, CaloFittingOps::ihcal_software_zs);
  ...
  //30 ADC SZS
  ctbOHCal->set_softwarezerosuppression(true, CaloFittingOps::ohcal_software_zs);
